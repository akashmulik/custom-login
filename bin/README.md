...
```bash
cd custom-login
mvn -Dokta.oauth2.issuer=https://dev-928527.okta.com/oauth2/default \
    -Dokta.oauth2.clientId=0oatahibcQ7YNxjED4x6 \
    -Dokta.oauth2.clientSecret=yvI2jdrWVK9XH2dPloPMy3_-av0yXFBcP-o5Pzs0
```
...
```bash
export OKTA_OAUTH2_ISSUER=https://dev-928527.okta.com/oauth2/default
export OKTA_OAUTH2_CLIENT_ID=0oatahibcQ7YNxjED4x6
export OKTA_OAUTH2_CLIENT_SECRET=yvI2jdrWVK9XH2dPloPMy3_-av0yXFBcP-o5Pzs0
```
